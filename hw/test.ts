...
import {getWidget, Context, StrategyA} from "./hw-refactoring-code";
...
async function test() {
    ...
    const res1 = await context.doSomeBusinessLogic(await getWidget("1", "1", "1") as Widget);
    ...
    const res2 = await context.doSomeBusinessLogic(await getWidget("1", "1", "7") as Widget);
    ...
    const res3 = await context.doSomeBusinessLogic(await getWidget("1", "1", "6") as Widget);
